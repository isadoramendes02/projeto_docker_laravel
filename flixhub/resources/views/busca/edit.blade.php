...
<div class="dashboard-wrapper">
    ...
    <div class="container conteudo-pagina-fixa">
        ...
        <div class="form-container">
            <h1>Editar Item da Minha Lista</h1>
            ...
            <form action="{{ route('busca.update', $busca->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="titulo_obra" name="titulo_obra" value="{{ $busca->titulo_obra }}" class="form-control" readonly>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="comentario" id="comentario" class="form-control" rows="4" required>{{ $busca->comentario }}</textarea>
                </div>
